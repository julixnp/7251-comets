...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(30, 0, 9.5
            ,
     ...
     * used. The default values w
     *
     * ere selected with inches in mind. Road runner uses radians for
     * angular distances although most angular parameters are wrapped in Math.toRadians() for
     * convenience. Make sure to exclude any gear ratio included in MOTOR_CONFIG from GEAR_RATIO.
     */
    public static double WHEEL_RADIUS = 1.8898; // in
    public static double GEAR_RATIO = 1.02678; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 10.21;
    ...
    public static double MAX_ANG_VEL = 6.879111480712891;
